...
function updateInfoPanel() {
    if (currentModel) {
        const modelData = {
            "url": modelUrl || "N/A",
            "position": [currentModel.position.x.toFixed(2), currentModel.position.y.toFixed(2), currentModel.position.z.toFixed(2)],
            "scale": [currentModel.scale.x.toFixed(2), currentModel.scale.y.toFixed(2), currentModel.scale.z.toFixed(2)],
